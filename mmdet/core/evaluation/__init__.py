from .class_names import (voc_classes, person_classes, anonym_classes, imagenet_det_classes,
...
__all__ = [
    'voc_classes','person_classes', 'anonym_classes', 'imagenet_det_classes', 'imagenet_vid_classes',
